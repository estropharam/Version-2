                                    ...
                                    <div class="col-sm-6 col-lg-4 m-15px-tb">
                                        <div style="background-color: #EEEEEE;border-radius: 23px;" class="media box-shadow-only-hover hover-top border-all-1 border-color-gray p-15px">
                                            ...
                                            <div class="icon-50 green-bg white-color border-radius-50 d-inline-block">
                                                <i class="number">HCE</i>
                                            </div>
                                            <div class="p-20px-l media-body">
                                                <span class="theme2nd-bg white-color p-0px-tb p-10px-lr font-small border-radius-15">Full
                                                    time</span>
                                                <h6 class="m-5px-tb"><b>Health Care Executive</b></h6>
                                                <p>Estro Pharmaceuticals Pvt. Ltd. is seeking a dedicated Healthcare Executive to join our team. The ideal candidate will drive strategic initiatives, manage key client relationships, and deliver exceptional healthcare solutions. </p>
                                    ...
                                    <div class="col-sm-6 col-lg-4 m-15px-tb">
                                        <div style="background-color: #EEEEEE;border-radius: 23px;" class="media box-shadow-only-hover hover-top border-all-1 border-color-gray p-15px">
                                            ...
                                            <div class="icon-50 yellow-bg white-color border-radius-50 d-inline-block">
                                                <i class="number">PMT</i>
                                            </div>
                                            <div class="p-20px-l media-body">
                                                <span class="theme2nd-bg white-color p-0px-tb p-10px-lr font-small border-radius-15">Full
                                                    time</span>
                                                <h6 class="m-5px-tb"><b>Product Management Team</b></h6>
                                                <p>Estro Pharmaceuticals Pvt. Ltd. is hiring a proactive PMT Executive for product lifecycle management, market research, and promotional activities. Join us to help meet market demands and business goals.</p>
                                                <p class="m-0px font-small">
                                                <h6>INDIA,UP</h6>
                                                </p>
                                    ...
                                    <div class="col-sm-6 col-lg-4 m-15px-tb">
                                        <div style="background-color: #EEEEEE;border-radius: 23px;" class="media box-shadow-only-hover hover-top border-all-1 border-color-gray p-15px">
                                            ...
                                            <div class="p-20px-l media-body">
                                                <span class="theme2nd-bg white-color p-0px-tb p-10px-lr font-small border-radius-15">Full
                                                    time</span>
                                                <h6 class="m-5px-tb"><b> Healthcare Professional</b></h6>
                                                <p>Estro Pharmaceuticals Pvt. Ltd. welcomes talented and motivated individuals to join our team in healthcare roles, including Area Sales Manager(ASM), Senior Sales Manager(Sr ASM), and Healthcare Executive(HCE).</p>
                                                <p class="m-0px font-small">
                                                <H6>INDIA,UP</H6>
                                                </p>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <ul style="list-style: circle;">
                                                        <li>Driving strategic healthcare initiatives.</li>
                                                        <li>Building and maintaining important client relationships.</li>
                                                        <li>Collaborating on delivering high-quality healthcare solutions.</li>
                                                        <li>Staying informed about industry trends and opportunities.</li>
                                                    </ul>
                                                    <h5>Qualifications:</h5>
                                                    <ul style="list-style: circle;">
                                                        <li>Bachelor’s degree in Pharmacy, Life Sciences, Business, or related field.</li>
                                                        <li>Experience in healthcare sales or pharmaceutical marketing is preferred.</li>
                                                        <li>Strong communication, interpersonal, and organizational skills.</li>
                                                        <li>Knowledge of healthcare industry regulations and trends.</li>
                                                    </ul>
                                                    <p>Feel free to adjust any of these based on the specific needs and focus of your position.</p>
                                                            ...
                                                            <form id="fmor" target="none">
                                                                   ...
                                                                   <div class="row">
                                                                     <div>
                                                                       ...
                                                                       <select style="width: 20%;text-align: center;height: 47px;border-radius: 0.3em;border: none;">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div style="padding: 7px;" class="modal-body">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <h3>Healthcare Professional
                                                    </h3>
                                                    <p>Estro Pharmaceuticals Pvt. Ltd. is a leading pharmaceutical company focused on developing high-quality medications to improve health outcomes globally,</p>
                                                    <h5>Key Responsibilities:</h5>
                                                    <ul style="list-style: circle;">
                                                        <li>Develop and execute sales strategies to achieve targets.</li>
                                                        <li>Build and maintain strong relationships with healthcare professionals and institutions.</li>
                                                        <li>Provide product information and training to medical staff.</li>
                                                        <li>Analyze market trends and adjust sales strategies accordingly.</li>
                                                    </ul>
                                                    <h5>Qualifications:</h5>
                                                    <ul style="list-style: circle;">
                                                        <li>Bachelor's degree in Pharmacy, Medicine, or a related field.</li>
                                                        <li>Proven experience in the pharmaceutical or healthcare industry.</li>
                                                        <li>Excellent communication and interpersonal skills.</li>
                                                        <li>Strong organizational and time management abilities.</li>
                                                    </ul>
                                                    <p>Come talk to us at the job fair to learn more about this exciting opportunity to advance your career in healthcare!</p>
                                                    <p>Feel free to adjust any of these based on the specific needs and focus of your position.</p>
                                                    </div>
                                                <div style="padding: 0;" class="col-lg-6">
                                                    <div class="container-fluid">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div style="padding: 7px;" class="modal-body">
                                                                <div class="container-fluid">
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <h3>Product Management Team
                                                                            </h3>
                                                                            <p>Estro Pharmaceuticals Pvt. Ltd. is a leading pharmaceutical company dedicated to developing high-quality medications to improve global health outcomes.</p>
                                                                            <h5>Key Responsibilities:</h5>
                                                                            <ul style="list-style: circle;">
                                                                                <li>Market Research: Identify opportunities and analyze competitors.</li>
                                                                                <li>Product Development: Collaborate on product design and specifications.</li>
                                                                                <li>Product Launch: Develop and execute launch plans; create marketing strategies.</li>
                                                                                <li>Lifecycle Management: Monitor performance, manage updates, and handle product discontinuations.</li>
                                                                            </ul>
                                                                            <h5>Qualifications:</h5>
                                                                            <ul style="list-style: circle;">
                                                                                <li>Degree in Business, Marketing, Pharmacy, or related field.</li>
                                                                                <li>Experience in product management, preferably in pharmaceuticals.</li>
                                                ...
                                                <div style="background-color:#EEEEEE;" class="container-fluid">
                                                    <div style="padding: 6% 0; " class="row">
                                                        <h2 style="display: flex;justify-content: center;padding-bottom:2%;font-size: 3em;">Why Join Us
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <h2>Growth and Development Opportunities</h2>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="col-2"><svg style="color: #FF7F3E;" xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-1-circle-fill" viewBox="0 0 16 16">
